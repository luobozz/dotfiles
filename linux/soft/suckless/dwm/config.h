...
static char *fonts[]          = {"JetBrains Mono:style=Bold:pixelsize=14:antialias=true:autohint=true","Fira Code Nerd Font Mono:pixelsize=20:antialias=true:autohint=true"};
