...
/* appearance */
static unsigned int borderpx  = 11;        /* border pixel of windows */
static unsigned int snap      = 32;       /* snap pixel */
static unsigned int gappih    = 50;       /* horiz inner gap between windows */
static unsigned int gappiv    = 50;       /* vert inner gap between windows */
static unsigned int gappoh    = 50;       /* horiz outer gap between windows and screen edge */
static unsigned int gappov    = 50;       /* vert outer gap between windows and screen edge */
